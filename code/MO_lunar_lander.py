...
class LunarLander(gym.Env, EzPickle):
    ...
    def step(self, action):
        ...
        return np.array(state, dtype=np.float32), np.array([shaping_reward, -m_power, -s_power, result_reward]), done, {}
...
register(id='MO_LunarLander-v0', entry_point='MO_lunar_lander:LunarLanderContinuous')
